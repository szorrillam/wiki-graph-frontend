    ...
    <div className="min-h-full">
      {!title && (
        <div className="mx-auto max-w-3xl p-6">
          <div className="card">
            <div className="mb-2 text-lg font-semibold text-brand-700">Seleccione un artículo para explorar</div>
            <p className="text-sm text-gray-600">Vaya a la página de "Explorar" en endpoints o use la ruta /explore/{`{title}`}.</p>
          </div>
        </div>
      )}
      <Toolbar
